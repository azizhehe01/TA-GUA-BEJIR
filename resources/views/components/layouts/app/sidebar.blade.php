<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark custom-scrollbar">
    <head>
        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-slate-950">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="folder"  :href="route('fim.dashboard')" :current="request()->routeIs('fim.dashboard')" wire:navigate>{{ __('FIM Dashboard') }}</flux:navlist.item>
                </flux:navlist.group>
